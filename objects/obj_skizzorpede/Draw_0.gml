...
for (_segment = segments; _segment > 0; --_segment)
{
	...
	draw_sprite_ext(spr_skizzorpede_body, 0, _segment_x_delta, _segment_y_delta, 1, 1, point_direction(_segment_x_delta, _segment_y_delta, _segment_x, _segment_y), c_white, 1);
}
...
_segment_x_delta = lerp(_segment_x_previous, _segment_x, _frame_delta);
_segment_y_delta = lerp(_segment_y_previous, _segment_y, _frame_delta);
draw_sprite_ext(spr_skizzorpede_head, image_index, _segment_x_delta, _segment_y_delta, 1, 1, point_direction(_segment_x_delta, _segment_y_delta, _segment_x, _segment_y), c_white, 1);