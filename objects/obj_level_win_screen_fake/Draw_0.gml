...
draw_rectangle(_view_x1 + _screen_width_fourth * 0, _view_y1 +_rec_A_y1 + _lower_offset, _view_x1 + (_screen_width_fourth * 1), _view_y1 + _rec_A_y2, false);
draw_rectangle(_view_x1 + _screen_width_fourth * 1, _view_y1 +_rec_B_y1 + _lower_offset, _view_x1 + (_screen_width_fourth * 2), _view_y1 + _rec_B_y2, false);
draw_rectangle(_view_x1 + _screen_width_fourth * 2, _view_y1 +_rec_A_y1 + _lower_offset, _view_x1 + (_screen_width_fourth * 3), _view_y1 + _rec_A_y2, false);
draw_rectangle(_view_x1 + _screen_width_fourth * 3, _view_y1 +_rec_B_y1 + _lower_offset, _view_x1 + (_screen_width_fourth * 4), _view_y1 + _rec_B_y2, false);
...
if (state >= 3)
{
	...
	draw_set_color(c_white);
	draw_circle(_view_x1 + _screen_width_half, _view_y1 + _screen_height_half + _lower_offset, 80, false);
